...
class Database:
    ...
    async def create_table_movies(self):
        sql = """
        CREATE TABLE IF NOT EXISTS "bot_admin_movie" (
        id BIGSERIAL PRIMARY KEY,
    ...
    async def create_table_channels(self):
        sql = """
        CREATE TABLE IF NOT EXISTS "bot_admin_channel" (
